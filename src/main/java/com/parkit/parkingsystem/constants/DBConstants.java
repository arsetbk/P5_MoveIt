...
/**
 * Class containing the Database constant requests
 */
public class DBConstants {
    ...
    public static final String GET_TICKETS = "select t.VEHICLE_REG_NUMBER, t.ID from ticket t where t.VEHICLE_REG_NUMBER=?";
}
